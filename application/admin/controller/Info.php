...
class Info extends PublicInc
{
    ...
    public function index()
    {
        ...
        $Info = DB::table('bg_adminuser')->where('id = '.$uid)->field('id,name,truename,tel,email,lasttime,counts,lastip')->find();
        \think\View::share('user',$Info);
